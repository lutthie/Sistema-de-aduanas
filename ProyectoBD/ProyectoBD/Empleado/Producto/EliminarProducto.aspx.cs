...
namespace ProyectoBD.Empleado.Producto
{
    public partial class EliminarProducto : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            OracleCommand comando = new OracleCommand("SELECT nombre, descripcion FROM PRODUCTO WHERE ID_PRODUCTO = " + Label1.Text, ora);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                OracleCommand eliminar = new OracleCommand("DELETE FROM PRODUCTO WHERE ID_PRODUCTO ='" + Label1.Text + "'", ora);

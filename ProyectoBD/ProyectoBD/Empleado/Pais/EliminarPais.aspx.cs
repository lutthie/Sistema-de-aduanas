...
{
    public partial class EliminarPais : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            OracleCommand comando = new OracleCommand("SELECT nombre, region FROM PAIS WHERE ID_PAIS = " + Label1.Text, ora);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                OracleCommand eliminar = new OracleCommand("DELETE FROM PAIS WHERE ID_PAIS ='" + Label1.Text + "'", ora);

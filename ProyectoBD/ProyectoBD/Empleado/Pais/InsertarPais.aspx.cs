...
{
    public partial class InsertarPais : System.Web.UI.Page
    {
        ...
        protected void btnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                OracleCommand insertar = new OracleCommand("INSERT INTO PAIS VALUES ('" + TextBox1.Text + "','" + txtnombrep.Text + "','" + txtregion.Text + "')", ora);
